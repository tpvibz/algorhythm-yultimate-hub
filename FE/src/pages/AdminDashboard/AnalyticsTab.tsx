  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Tournament Analytics & Reports</h2>
      </div>
        ...
        <CardContent>
          <Select value={selectedTournament} onValueChange={setSelectedTournament}>
            <SelectTrigger className="w-full">
              <SelectValue placeholder="Select a tournament to view analytics" />
            </SelectTrigger>
            <SelectContent>
      ...
      {!selectedTournament && (
        <Card className="glass-card">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground">Select a tournament to view analytics</p>
          </CardContent>
        </Card>
      )}
      ...
      {selectedTournament && loading && (
        <Card className="glass-card">
          <CardContent className="p-12 text-center">
            <div className="animate-spin h-8 w-8 mx-auto mb-4 border-4 border-blue-600 border-t-transparent rounded-full" />
              ...
              <CardContent>
                <div className="space-y-4">
                  {summaryData.data.spiritRankings.map((ranking, index) => (
                    <div key={ranking.teamId} className="flex items-center justify-between p-4 rounded-lg bg-gradient-to-r from-blue-500/5 to-blue-600/5">
