            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="rounded-full gap-2 hover:bg-indigo-500/10 hover:text-indigo-600"
                ...
                {showRoleMenu && (
                  <div className="absolute top-full mt-2 right-0 w-48 bg-card/95 backdrop-blur-xl border border-border rounded-lg shadow-xl overflow-hidden animate-slide-up">
                    ...
                    <button
                      ...
                      className="w-full px-4 py-3 text-left text-sm hover:bg-green-500/10 hover:text-green-600 transition-colors flex items-center gap-2"
                    >
          ...
          {isOpen && (
            <div className="py-4 space-y-3 animate-slide-up">
              <button 
                ...
                className="flex items-center gap-2 py-2 w-full text-foreground hover:text-purple-600 transition-colors"
              >
                <Home className="h-4 w-4" />
                Dashboard
              </button>
